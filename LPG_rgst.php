...
,jggtiir
	 ...
	 else
	{
		...
		$qry = "select * from lpg_rgst where Username='$username'";
		$rsl = $conn->query($qry);
		...
		{
			$qry = "insert into lpg_rgst(Username,Password,Phone_number,Address)
...
<center><h1><b><i>Registration  Form For LPG Service </i></b></h1></center>
