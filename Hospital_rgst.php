...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
		$qry = "select * from h_rgst where Username='$username'";
		$rsl = $conn->query($qry);
		...
		{
			$qry = "insert into h_rgst(Username,Password,Phone_number,Address)
...
<center><h1><b><i>Registration  Form For Hospital  Service</i></b></h1></center>
